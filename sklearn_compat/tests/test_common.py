...
class Classifier(_ParamsValidationMixin, ClassifierMixin, BaseEstimator):
...
class Regressor(_ParamsValidationMixin, RegressorMixin, BaseEstimator):
...
class Transformer(_ParamsValidationMixin, TransformerMixin, BaseEstimator):
