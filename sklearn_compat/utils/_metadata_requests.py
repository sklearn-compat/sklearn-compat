...
from ._version import sklearn_version, parse_version

if parse_version(sklearn_version.base_version) < parse_version("1.6"):
    ...
    from sklearn.utils._metadata_requests import (  # type: ignore[no-redef]
        COMPOSITE_METHODS,  # noqa : F401
        METHODS,  # noqa : F401
        SIMPLE_METHODS,  # noqa : F401
        UNCHANGED,
        UNUSED,
        WARN,
        MetadataRequest,
